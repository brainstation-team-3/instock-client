...
export default function WarehouseInventoryItem({ item }) {
    ...
    return (
        <div key={id} className="grid grid-cols-2 border-b bg-white px-6 py-8 shadow-md border-instock-cloud
            ...
            <div className="mb-4 md:mb-0 md:col-start-1">
                ...
                <p className="cursor-pointer font-bold capitalize text-instock-indigo min-w-fit whitespace-nowrap">{item_name}</p>
            ...
            <div className="col-span-2 flex items-center justify-between md:col-span-1 md:mr-2 md:mb-0 md:justify-end md:gap-4 md:col-start-6">
