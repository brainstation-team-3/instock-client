...
const TableHeader = ({ columns, type }) => {
  ...
  return (
    <div
      className={`hidden px-6 bg-instock-light-grey/70 md:grid md:justify-start md:px-10 md:py-2 md:text-sm md:grid-cols-5 ${type === 'inventory' ? '[&>*:nth-child(4)]:md:ml-28' : ''}`}>
