...
const ItemAvailability = ({warehouseList, findWarehouseId}) => {
  ...
  return (
    <div className="bg-blue-500 mx-[-1rem] border-b border-instock-cloud p-4 md:mx-0 md:my-4 md:border-b-0 md:border-r md:px-6 md:py-0">
